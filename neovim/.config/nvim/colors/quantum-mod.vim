...
let s:yellow    = ['#e1be68', 49] " original: 221, now it's green
...
let s:deop_bg  = ['#000000', 245]
"let s:deop_txt = ['#000000', 250]
let s:deop_el  = ['#000000', 255]
...
call s:HL('Pmenu',                          '',         s:deop_bg,  '')
call s:HL('PmenuSbar',                      '',         s:gray2,    '')
call s:HL('PmenuSel',                       s:gray2,    s:deop_el,  '')
